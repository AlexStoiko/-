...
namespace Games {
	...
	/// </summary>
	public ref class About_Games : public System::Windows::Forms::Form
	{
	public:
		About_Games(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->cloz->Click += gcnew System::EventHandler(this, &About_Games::cloz_Click);
			// 
			// About_Games
			// 
